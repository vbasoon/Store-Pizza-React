...
const CartItem = (props) => {
   ...
   const handleAddTo = () => {
      props.onAddTo(props.id);
   }

   const handleRemoveFrom = () => {
      props.onRemoveFrom(props.id);
   }
      ...
      <>
         <div className="cart__item">
            ...
            <div className="cart__item-info">
               <h3>{props.name}</h3>
               <p>{props.type} тісто, {props.size} см.</p>
            </div>
            <div className="cart__item-count">
               <div onClick={handleRemoveFrom} className="button button--outline button--circle cart__item-count-minus">
                  <svg
               ...
               <div onClick={handleAddTo} className="button button--outline button--circle cart__item-count-plus">
                  <svg
